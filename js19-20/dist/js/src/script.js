    ...
    function action(){
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          for (var i = 0; i < 7; i++) {
            var $img = ('<div class="img__container"><div style="background: url('+data.hits[i].webformatURL+'); background-size: cover; background-position: center;" class="img__search"></div><span class="img__text">' + data.hits[i].tags + '</span></div>');
